...
--
-- Host: localhost
-- Generation Time: 2015-11-29 13:05:59
-- 服务器版本： 5.7.9
-- PHP Version: 5.6.2
...
--
ALTER TABLE `player`
  MODIFY `id` mediumint(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=536;
--
...
--
ALTER TABLE `transfer`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3500;
--
...
--
ALTER TABLE `transfermarkt_transfer_transfer`
  MODIFY `id` mediumint(7) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3500;
--
...
--
ALTER TABLE `whoscored_match_event`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147410446;
--
