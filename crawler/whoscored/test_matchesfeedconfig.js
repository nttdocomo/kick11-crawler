...
crawler.on("fetchcomplete",function(queueItem, responseBuffer, response){
    ...
    if(parsedURL.uriPath != '/Error.html' && (/^\/StatisticsFeed\/\S+?teamIds\=(13|30)&matchId\=959629/.test(parsedURL.path) || /^\/matchesfeed\/\?d\=\d{8}$/.test(parsedURL.path) || /^\/MatchesFeed\/959629\/MatchCentre2$/.test(parsedURL.path))){
